...
const Footer = () => {
    return (
        <footer class="footer footer-center p-10 shadow-inner shadow-orange-500 bg-base-200 text-secondary-content">
            <div>
                ...
                <p class="font-bold">
                    Elevator Manufacturing Inc. <br/>Providing reliable tech since 2016
                </p>
