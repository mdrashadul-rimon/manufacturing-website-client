...
const MyProfile = () => {
    ...
    const { data: profile, isLoading } = useQuery('profile', () => fetch('https://limitless-hollows-00488.herokuapp.com/profile').then(res => res.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://limitless-hollows-00488.herokuapp.com/profile', {
                        method: 'POST',
                        headers: {
